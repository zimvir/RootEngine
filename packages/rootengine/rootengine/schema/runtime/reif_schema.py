...
JSON_DICT = { 'conversation.simple_conversation': { '$schema': 'http://json-schema.org/draft-07/schema#',
                                        ...
                                        'type': 'array'},
  'tool.tool_record': { '$schema': 'http://json-schema.org/draft-07/schema#',
                        'patternProperties': { '.*': { 'properties': { 'tool_call': { 'description': '见官方规范',
                                                                                      'type': 'object'},
                                                                       'tool_result': { 'description': '见官方规范',
                                                                                        'type': 'object'}},
                                                       'type': 'object'}},
                        'title': 'tool record entry',
                        'type': 'object'}}
